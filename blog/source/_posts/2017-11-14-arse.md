...
[android-arscblamer](https://github.com/google/android-arscblamer)工程中的**src/main/resources**目录中包含了本文分析的资源文件(apk,resources.arsc,以及详细的二进制文件解析的注释文件resources.md和工程生产的excel文件),本文主要起一个引子的作用，教会大家如何分析resources.arsc这个二进制文件，好了，废话完毕，让我们进入主题吧
...
# 修改的android-arscblamer

到这里，resources.arsc就分析的差不多了，[android-arscblamer](https://github.com/google/android-arscblamer)我将输出信息可以输出到excel中，类似于studio查看apk文件的方式  
